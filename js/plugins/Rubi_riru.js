...
var ruby_dic = [["肖死","あやかし"],["肖師","おくりびと"],["四十八願","よいなら"],["明保能","あけぼの"],["雅楽代","うたしろ"],["花魁鳥","えとぴりか"],["十七夜","かのう"],["神々廻","ししべ"],["西風舘","ならいだて"],["雲類鷲","うるわし"],["雛罌粟","こくりこ"],["鷹左右","たかそう"],["卍山下","まんざんか"],["御薬袋","みない"],["山楝蛇","やまかがし"],["沼沢菊","ぬまざわぎく"],["夕星","ゆうせい"],["寒天橋","かんてんばし"],["陽卯〇〇","ごぜんよじ"],["泰然自若","たいぜんじじゃく"],["侘","わび"],["趣が","おもむき"],["古より","いにしえ"],["畏怖","いふ"],["肖り","あやか"],
["肖る","あやか"],["肖ろ","あやか"],["怪訝","けげん"],["誰ソ","た"],["彼会","がれかい"],["陰申〇〇","ごごくじ"],["陰巳〇〇","ごごろくじ"],["陰酉〇〇","ごごじゅうじ"],["陰戌〇〇","ごごじゅういちじ"],["陽午三〇","ごぜんはちじはん"],["猜疑心","さいぎしん"],["土下座侍","どげざむらい"],["聡い","さと"]];
    return ruby_dic;
};
